...
**Er - UserBot**
➖➖➖➖➖➖➖➖➖➖
**Rewrite**: [{OWNER}](tg://user?id={ultroid_bot.uid})
**Ch**: @pamerdong
➖➖➖➖➖➖➖➖➖➖
"""
...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/ErRickow/Ultroid",
        ),
        Button.url("Support", url="https://t.me/pamerdong"),
    ]
]
