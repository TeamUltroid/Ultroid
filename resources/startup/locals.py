...
def start():
    ...
    try:
        ...
        pass
    os.system("git clone https://github.com/Gladiator-007/Ultroid")
    print("\n\nDone")
    os.chdir("Ultroid")
    clear_screen()
    print(a)
    ...
    if isitdone == "y":
        # https://github.com/Gladiator-007/Ultroid/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
        f.close
    elif isitdone == "n":
