...
from utilities.helper import check_reply_to, inline_mention, async_searcher
from ulities.tools import (
    create_tl_btn,
    get_chatbot_reply,
)
...
from . import LOG_CHANNEL, LOGS, asst, get_string, ultroid_bot, types, udB
...
async def DummyHandler(ult):
    ...
    if ult.user_joined or ult.added_by:
        ...
        # gbans and @UltroidBans checks and @UFoPSpammerLogs
