...
<stong>Ultroid <a href=https://github.com/Gladiator-007/Ultroid>[v{ultroid_version}]</a>, powered by @Gladiator-007</strong>
"""
...
_start = [
    [
        Button.inline("Lᴀɴɢᴜᴀɢᴇ ☣️", data="lang"),
    ...
    if event.is_group:
        ...
        if str(event.sender_id) not in owner_and_sudos():
            ...
            if not udB.get("STARTMSG"):
                ...
                await event.reply(
                    f"Hey there [{get_display_name(u)}](tg://user?id={u.id}), this is Jarvis Assistant of [{ultroid_bot.me.first_name}](tg://user?id={ultroid_bot.uid})!\n\n{ok}",
