...
async def set_time(e):
    if not e.pattern_match.group(1):
        return await eor(e, get_strings('nightm_1'))
    try:
        ...
        await eor(e, get_strings('nightm_2'))
    except BaseException:
        await eor(e, get_strings('nightm_1'))
...
async def add_grp(e):
    ...
    if pat:
        try:
            ...
            return await eor(e, get_strings('nightm_5'), time=5)
    add_night(e.chat_id)
    await eor(e, get_strings('nightm_3'))
...
async def rem_grp(e):
    ...
    if pat:
        try:
            ...
            return await eor(e, get_strings('nightm_5'), time=5)
    rem_night(e.chat_id)
    await eor(e, get_strings('nightm_4'))
