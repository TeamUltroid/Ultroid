...
async def download_from_youtube_(event):
    ...
    if opt == "a":
        ...
        try:
            ...
            return await eor(event, "Give me a (youtube) search query to download audio from!")
        ...
        try:
            ...
            return await eor(event, "Give me a (youtube) search query to download video from!")
