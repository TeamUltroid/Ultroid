...
KANGING_STR = [
    ...
    "Kanging sticker ini...",
    "Oii, itu stickernya bagus!\nMikir ketika aku sedang kang?!..",
    "Hehe gw nyolong sticker lu...",
    "oy lihat disana (☉｡☉)!→\nKetika gw lagi kang sticker ini...",
    "Roses adalah Merah,Violet adalah Biru, kanging Sticker ini, jadi sticker gw keliatan mantap",
